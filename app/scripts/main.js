...
(function() {
	...
	function mainCtrl($http, $templateCache) {
		...
		model.test = 'test';
		model.method = 'JSONP';
		model.url = 'https://openagenda.com/agendas/7663254/events.json?page=1&search%5Bpassed%5D=1&callback=JSON_CALLBACK';
	...
	function zoomCtrl($http, $templateCache) {
		...
		model.test = 'test';
		model.method = 'JSONP';
		model.url = 'https://openagenda.com/agendas/7663254/events.json?page=1&search%5Bcategory%5D=zoom&callback=JSON_CALLBACK';
